...
public class VersionResolver
{
    ...
    public void Add(string dependency, string versionSpec)
    {
    ...
    public void Add(string dependency, VersionConstraint constraint)
    {
    ...
    public bool TryGetRange(string dependency, out string min, out string max)
    {
        if (!dependencies.TryGetValue(dependency, out var range))
        {
            min = string.Empty;
